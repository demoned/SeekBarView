...
public class Builder {
    ...
    int indicatorColor = Color.parseColor("#C1D114");
    ...
    int trackProgressColor = Color.parseColor("#C1D114");
    boolean trackRoundedCorners = false;
    //thumbText
    int thumbTextColor = Color.parseColor("#C1D114");
    boolean showThumbText = false;
    //thumb
    int thumbSize = 0;
    int thumbColor = Color.parseColor("#C1D114");
    ColorStateList thumbColorStateList = null;
    Drawable thumbDrawable = null;
    //tickTexts
    boolean showTickText;
    int tickTextsColor = Color.parseColor("#C1D114");
    int tickTextsSize = 0;
    ...
    int tickMarksColor = Color.parseColor("#C1D114");
    int tickMarksSize = 0;
    ...
    Builder(Context context) {
        ...
        this.trackBackgroundSize = SizeUtils.dp2px(context, 3);
        this.trackProgressSize = SizeUtils.dp2px(context, 3);
        this.tickMarksSize = SizeUtils.dp2px(context, 10);
        this.tickTextsSize = SizeUtils.sp2px(context, 13);
        this.thumbSize = SizeUtils.dp2px(context, 100);
    }
